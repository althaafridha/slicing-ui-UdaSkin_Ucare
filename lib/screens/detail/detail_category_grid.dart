...
import 'package:slicing_ui_ucare/screens/detail/detail_product.dart';
      ...
      child: GridView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          return GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const DetailProductPage())),
            child: Container(
